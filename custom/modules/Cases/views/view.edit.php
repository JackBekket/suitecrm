...
class CasesViewEdit extends ViewEdit {
    ...
    function display(){
        ...
        //$editors = 'update_text,description';
        //if(!empty($this->bean->external_source) && $this->bean->external_source == 'personal_cabinet') {
        //    $editors = 'update_text';
        //}
        //echo $tiny->getInstance($editors, 'email_compose_light');
    }
